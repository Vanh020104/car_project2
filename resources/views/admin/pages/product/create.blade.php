            ...
            <div class="card-body">
             <div class="ttcar1">
                 <div class="form-group">
                     ...
                     <input style="margin-left: 15px" type="text" name="name" value="{{old("name")}}" class="form-control"  placeholder="Enter Name" required>
                     @error("name")
                 ...
                 <div class="form-group">
                     ...
                     <input style="margin-left: 25px" type="number" value="{{old("price")}}" name="price" class="form-control"  placeholder="Price">
                     @error("price")
                     <p class="text-danger"><i>{{$message}}</i></p>
                     @enderror
                 </div>
                 ...
                 <div class="form-group">
                     <label>Qty</label>
                     <input style="margin-left: 40px" type="number" value="{{old("qty")}}" name="qty" class="form-control"  placeholder="Qty">
                     @error("qty")
                     <p class="text-danger"><i>{{$message}}</i></p>
                     @enderror
                 </div>
                ...
                <div style="margin-left: 40px" class="ttcar2">
                    ...
                    <div class="form-group">
                        <label>Door</label>
                        <input type="number" value="{{old("door")}}" name="door" class="form-control"  placeholder="Door">
                        @error("door")
                        <p class="text-danger"><i>{{$message}}</i></p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" value="{{old("car_year")}}" name="car_year" class="form-control"  placeholder="Car Year">
                        @error("car_year")
                        <p class="text-danger"><i>{{$message}}</i></p>
                        @enderror
                    </div>
                    <div class="form-group">
                        <label>Mileage</label>
                        <input type="number" value="{{old("mileage")}}" name="mileage" class="form-control"  placeholder="Mileage">
                        @error("mileage")
                        <p class="text-danger"><i>{{$message}}</i></p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" value="{{old("power")}}" name="power" class="form-control"  placeholder="Horsepower">
                        @error("power")
                        <p class="text-danger"><i>{{$message}}</i></p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="fuel_style" value="{{old("fuel_style")}}" class="form-control"  placeholder="Fuel Style" required>
                        @error("fuel_style")
                        <p class="text-danger"><i>{{$message}}</i></p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="color" value="{{old("color")}}" class="form-control"  placeholder="Color" required>
                        @error("color")
                        <p class="text-danger"><i>{{$message}}</i></p>
                        @enderror
                    </div>
