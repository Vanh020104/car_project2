...
@section("content")
                ...
                <div class="card">
                    ...
                    <table class="table table-striped table-borderless">
                        ...
                        <tr>
                            ...
                            <th style="margin-left: 20px;width: 200px">Action</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($orders_wc as $item)
                            <tr style="height: 50px">
                                ...
                                <td  style="text-align: center;margin-left: 20px">
                                    <form action="{{url("admin/confirmCancel",['order'=>$item->id])}}" method="post">
                                        @csrf
                                        @method("put")
                                        <button name="status" value="6" style="background-color: slategray;padding-left: 10px;padding-right: 10px;padding-top: 5px;border-radius: 6px;padding-bottom:5px;color: white " class="btn btn-outline-info">Accept Cancellation</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
    ...
    @else
        <p style="font-size: 25px;text-align: center;color: blue;margin-top: auto;margin-bottom: auto;margin-left: auto;margin-right: auto" class="text-xl font-bold text-black dark:text-white">
            No cancellation requests for car rentals today.</p>
    @endif
